...
const locationCategories = [
  {
    ...
    items: [
      { name: 'Eastern Express Highway', time: '01 Min' },
      { name: 'Sion Metro Station', time: '05 Mins' },
      { name: 'BKC', time: '15 Mins' },
      { name: 'Chhatrapati Shivaji Maharaj Airport', time: '20 Mins' },
    ],
  },
  {
    ...
    items: [
      { name: "Little Angel's School", time: '02 Mins' },
      { name: 'Don Bosco International School', time: '05 Mins' },
      { name: 'Shishuvan School', time: '10 Mins' },
      { name: 'Dhirubhai Ambani International School', time: '20 Mins' },
    ],
  },
  {
    title: 'Healthcare',
    ...
    items: [
      { name: 'Gleneagles Hospital Mumbai', time: '03 Mins' },
      { name: 'S L Raheja Hospital', time: '05 Mins' },
      { name: 'P. D. Hinduja Hospital & Medical Research Centre', time: '10 Mins' },
      { name: 'Zen Multi Speciality Hospital', time: '20 Mins' },
    ],
  },
  {
    ...
    items: [
      { name: 'Bharat Ratna Rajiv Gandhi Stadium', time: '05 Mins' },
      { name: 'Dadar Chowpatty', time: '07 Mins' },
      { name: 'ITC Grand Central', time: '10 Mins' },
      { name: 'Water Kingdom', time: '20 Mins' },
    ],
  },
]
    ...
    <section id="location" style={{
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div style={{ marginBottom: '36px', textAlign: 'center' }} data-aos="fade-up">
          ...
          }}>Bhaudaji Road, Matunga East, Mumbai</span>
          <h2 style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  Bhaudaji Road, Matunga East, Mumbai
                </span>
              </div>
            </div>
          </div>
